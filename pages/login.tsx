...
export default function Login() {
  return <>
    ...
    <Image src={"/mandalahalf.png"} alt="" width={500} height={500} className="fixed left-0 rotate-180 h-screen" /><div className="heading ml-auto mt-12">
      ...
      <div className="px-32">
        ...
        <button className="m-auto mt-10 w-60 border border-[#620045] text-[#610045A3] px-10 py-2 block text-xl">log in</button>
      </div>
    </div>
  </>
}